...
class CmsHtml
{
    ...
    private static function addFavicon()
    {
        ...
        elseif(is_file($theme->basePath . DS . 'favicon.ico?v=1')) {
        	$cs->registerLinkTag('shortcut icon', 'image/x-icon', $theme->baseUrl . '/favicon.ico?v=1');
        } 
        elseif(is_file($webroot . DS . 'favicon.png')) {
        	$cs->registerLinkTag('shortcut icon', 'image/png', '/favicon.png');
        } 
        else {
        	$cs->registerLinkTag('shortcut icon', 'image/x-icon', '/favicon.ico?v=1');
        }
    }
}
