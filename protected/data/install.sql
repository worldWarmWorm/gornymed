...
INSERT INTO event VALUES (1, 'Создали сайт', 'Мы создали сайт!', '<p>Мы создали сайт!</p>', 0, now(), '', 1);

INSERT INTO menu (id, title, type, options, ordering, `default`, hidden) VALUES
  (1, 'Главная', 'model', '{"model":"page","id":"1"}', 1, 1, 1),
  (2, 'Новости', 'model', '{"model":"event"}', 2, 0, 0);
INSERT INTO page VALUES (1, 0, 0, 'index', 'Главная', '', '<p>Сайт находится в разработке</p>', now(), now());
